...
from rest_framework.authentication import TokenAuthentication # 유저 식별 api, 사용자 인증
from rest_framework.permissions import IsAuthenticated # 인증된 유저들, 권한 부여
...
class Login(APIView):
    def post(self, request):
        ...
        if not username or not password:
            raise ParseError()
        user = authenticate(request, username=username, passworld=password)
